...
// ================================
// ✅ Direkte WP fetch via Vercel rewrite
// ================================
...
// ================================
// ✅ Legacy export til dashboardet (fixer build-fejl)
// DashboardRecentBookings.jsx importerer { fetchBookings } fra apiClient.
// ================================
export async function fetchBookings(query = {}) {
  // matcher "bookings" = reparationer i POS (repairs endpoint)
  return wpFetch({
